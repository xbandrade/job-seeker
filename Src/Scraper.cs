...
public class Scraper
{
    ...
    public List<Job> Scrape(string keywords = "", string location = "", string period = "")
    {
        string url = $"https://www.linkedin.com/jobs/search?keywords={keywords}&location={location}&f_TPR=r{period}";
        ...
        {
            Dictionary<string, string> jobData;
            try
            {
                jobData = new()
                {
